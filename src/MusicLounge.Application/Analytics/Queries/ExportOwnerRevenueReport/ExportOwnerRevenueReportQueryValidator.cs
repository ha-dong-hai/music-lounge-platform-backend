...
public sealed class ExportOwnerRevenueReportQueryValidator : AbstractValidator<ExportOwnerRevenueReportQuery>
{
    public ExportOwnerRevenueReportQueryValidator()
    {
