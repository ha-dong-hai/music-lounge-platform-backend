...
internal sealed class UpdateSeatingZoneCommandHandler : IRequestHandler<UpdateSeatingZoneCommand, Unit>
{
    private readonly IUnitOfWork _uow;
    private readonly ICurrentUserService _currentUser;

    public UpdateSeatingZoneCommandHandler(IUnitOfWork uow, ICurrentUserService currentUser)
    {
        _uow = uow;
