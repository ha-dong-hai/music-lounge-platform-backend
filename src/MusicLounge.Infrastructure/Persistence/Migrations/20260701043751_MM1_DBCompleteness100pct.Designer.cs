...
namespace MusicLounge.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260701043751_MM1_DBCompleteness100pct")]
    partial class MM1_DBCompleteness100pct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.SystemConfig", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            ConfigKey = "settlement_partial_pct",
                            ConfigValue = "0.70",
                            DataType = "Decimal",
                            Description = "Stage-1 settlement ratio (70% released at T+48h)",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            ...
                            ConfigValue = "3",
                            DataType = "Integer",
                            Description = "Days before show end: release 70%",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            ...
                            ConfigValue = "3",
                            DataType = "Integer",
                            Description = "Days after show end: release 30%",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 6,
                            ConfigKey = "ai_auto_pass_threshold",
                            ConfigValue = "0.20",
                            DataType = "Decimal",
                            Description = "AI moderation score below this → auto-pass — §6.11",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 7,
                            ConfigKey = "ai_auto_reject_threshold",
                            ConfigValue = "0.80",
                            DataType = "Decimal",
                            Description = "AI moderation score above this → auto-reject — §6.11",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            ConfigValue = "7",
                            DataType = "Integer",
                            Description = "Days before auto-confirm donation if Owner inactive — BR-05",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.LedgerEntry", b =>
                {
                    b.HasOne("MusicLounge.Domain.Entities.Account", null)
