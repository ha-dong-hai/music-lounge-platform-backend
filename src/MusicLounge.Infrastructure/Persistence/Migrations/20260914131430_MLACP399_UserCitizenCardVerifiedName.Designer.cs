...
namespace MusicLounge.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260914131430_MLACP399_UserCitizenCardVerifiedName")]
    partial class MLACP399_UserCitizenCardVerifiedName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.Donation", b =>
                {
                    ...
                    b.HasIndex("MessageHiddenByUserId");
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.DonationEvent", b =>
                {
                    ...
                    b.HasIndex("DonationId", "Sequence")
                        .IsUnique();
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.LoungeMute", b =>
                {
                    ...
                    b.ToTable("lounge_mutes", (string)null);
                });
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.LoungeShow", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("VenueMovedAt")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.MusicLounge", b =>
                {
                    ...
                    b.Property<string>("StatusReviewNote")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.PerformerConfirmation", b =>
                {
                    ...
                    b.ToTable("performer_confirmations", (string)null);
                });
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.RefundRequest", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("CashHandedBackAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<DateTimeOffset?>("PayoutAccountRequestedAt")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("CitizenCardVerifiedName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.UserDislikedGenre", b =>
                {
                    ...
                    b.ToTable("user_disliked_genres", (string)null);
                });
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.VenuePenalty", b =>
                {
                    ...
                    b.Property<decimal?>("SubscriptionCompensationDays")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<DateTimeOffset?>("SubscriptionCompensationFrom")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.Donation", b =>
                {
                    ...
                    b.HasOne("MusicLounge.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("MessageHiddenByUserId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.DonationEvent", b =>
                {
                    ...
                    b.HasOne("MusicLounge.Domain.Entities.Donation", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.LoungeStaff", b =>
                {
                    ...
                    b.HasOne("MusicLounge.Domain.Entities.User", "DeactivatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.PerformerConfirmation", b =>
                {
                    b.HasOne("MusicLounge.Domain.Entities.BankAccount", null)
                        .WithMany()
                        .HasForeignKey("BankAccountId")
                        .OnDelete(DeleteBehavior.NoAction);
