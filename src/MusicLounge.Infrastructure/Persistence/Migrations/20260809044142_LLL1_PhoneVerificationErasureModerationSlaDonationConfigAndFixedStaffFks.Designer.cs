...
namespace MusicLounge.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260809044142_LLL1_PhoneVerificationErasureModerationSlaDonationConfigAndFixedStaffFks")]
    partial class LLL1_PhoneVerificationErasureModerationSlaDonationConfigAndFixedStaffFks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MusicLounge.Domain.Entities.SystemConfig", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            ConfigKey = "settlement_days_before",
                            ConfigValue = "3",
                            DataType = "Integer",
                            Description = "Days before scheduled_start to release partial settlement",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 5,
                            ConfigKey = "settlement_days_after",
                            ConfigValue = "3",
                            DataType = "Integer",
                            Description = "Days after actual_end to release final settlement",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
