...
public sealed class FnbVenueGateTests
{
    ...
    private async Task<Venue> CreateVenueAsync()
    {
        ...
        // MLACP-397: chủ phòng trà đã được duyệt danh tính — bài ở đây xét trạng thái PHÒNG TRÀ; cổng danh tính người bán
        // có bài riêng (SellingRequiresVerifiedSellerTests).
        var owner = new User
        {
            Email = $"v380-{Guid.NewGuid():N}@test.com", FullName = "Test Venue Owner",
